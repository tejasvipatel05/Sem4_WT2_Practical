                    ...
                    <div className="d-flex justify-content-center mx-4 mb-4">
                        <div className="card" style={{ 'width': '18rem' }}>
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">Name: {Ele.name}</h5>
                                <p className="card-text">Email: {Ele.email}</p>
                                <p className="card-text">Phone No.: {Ele.phoneno}</p>
                                <p className="card-text">Department: {Ele.department}</p>
                                <p className="card-text">SPI: {Ele.spi}</p>
                            </div>
                        </div>
                    </div>
                )
